                            ...
                            <div class="categories-content rounded-bottom p-4 text-center" style="margin:-42px">
                                    ...
                                    <div class="blog-content rounded-bottom p-3">
                                        ...
                                        <strong>(<?php echo e($event->event_type); ?>)</strong>
                                          ...
                                          <strong>(<?php echo e($event->event_title); ?>)</strong>
                                      </br>
...
<?php echo $__env->make($activeTemplate.'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\getz\resources\views/templates/basic/incidents/indexIncidents.blade.php ENDPATH**/ ?>