...
<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('user.videos.update', $video->id)); ?>" method="post"
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="event_title" name="event_title" class="form-control"
                                           value="<?php echo e($video->event_title); ?>">
                                </div>
                            </div>
                         ...
                         <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date_event" name="date_event" class="form-control"
                                            value="<?php echo e($video->date_event); ?>">
                                </div>
                            </div>
                               ...
                               <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="event_type" name="event_type" required="">
                                        <option
                                                value="<?php echo e($video->event_type); ?>" selected><?php echo e($video->event_type); ?></option>
                               ...
                               <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control"
                                           value="<?php echo e($video->name); ?>" required>
                                </div>
                            </div>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="event_place" name="event_place" class="form-control"
                                          value="<?php echo e($video->event_place); ?>">
                                </div>
                            </div>
                               ...
                               <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="region" name="region" required="">
                                       <option
                                                value="<?php echo e($video->region); ?>" selected><?php echo e($video->region); ?></option>
                                                  <option>--- ----- --</option>
                                ...
                                <div class="form-group">
                                    <label for="category"><?php echo app('translator')->get('District(Wilaya)'); ?></label>
                                      <input type="text" id="district" name="district" class="form-control"
                                          value="<?php echo e($video->district); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" name="details" class="form-control nicEdit"
                                               id="nicEditor0"><?php echo e($video->details); ?></textarea>
                                </div>
                            </div>
                        

                          <div class="col-md-6">
                             <label for="name"><?php echo e($video->path); ?></label>
                             <br>
            <video controls width="120" height="120">
    <source src="<?php echo e(Storage::url($video->path)); ?>" type="video/mp4" style="object-fit: cover;">
...
<?php echo $__env->make('admin.layoutsuser.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\getz\resources\views/videos/editVideo.blade.php ENDPATH**/ ?>