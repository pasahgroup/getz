<div class="left side-menu">
          ...
          <ul>
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                 
                ...
                <li class="<?php echo e(classActivePath('deleted_users')); ?>"><a href="<?php echo e(URL::to('admin/deleted_users')); ?>" class="<?php echo e(classActivePath('deleted_users')); ?>"><i class="fa fa-users"></i><span><?php echo e(trans('words.deleted_users')); ?></span></a></li>
               </ul>
            </li>
            ...
            <li><a href="<?php echo e(URL::to('admin/payment_gateway')); ?>" class="waves-effect <?php echo e(classActivePath('payment_gateway')); ?>"><i class="fa fa-credit-card-alt"></i><span><?php echo e(trans('words.payment_gateway')); ?></span></a></li>
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                                 
                <li class="<?php echo e(classActivePath('pages')); ?>"><a href="<?php echo e(URL::to('admin/pages')); ?>" class="<?php echo e(classActivePath('pages')); ?>"><i class="fa fa-file"></i><span><?php echo e(trans('words.pages')); ?></span></a></li>
                <li class="<?php echo e(classActivePath('pages/add')); ?>"><a href="<?php echo e(URL::to('admin/pages/add')); ?>" class="<?php echo e(classActivePath('pages')); ?>"><i class="fa fa-plus"></i><span><?php echo e(trans('words.add_page')); ?></span></a></li>
               </ul>
            </li>

            <li class="has_sub"> 
              <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-play-circle"></i><span><?php echo e(trans('words.player_settings')); ?></span><span class="menu-arrow"></span></a>
              <ul class="list-unstyled">                                 
                <li class="<?php echo e(classActivePath('player_settings')); ?>"><a href="<?php echo e(URL::to('admin/player_settings')); ?>" class="<?php echo e(classActivePath('player_settings')); ?>"><i class="fa fa-cog"></i><span><?php echo e(trans('words.settings')); ?></span></a></li>
                
                <li class="<?php echo e(classActivePath('player_ad_settings')); ?>"><a href="<?php echo e(URL::to('admin/player_ad_settings')); ?>" class="<?php echo e(classActivePath('player_ad_settings')); ?>"><i class="fa fa-buysellads"></i><span><?php echo e(trans('words.player_ads')); ?></span></a></li>
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                 
                ...
                <li class="<?php echo e(classActivePath('menu_settings')); ?>"><a href="<?php echo e(URL::to('admin/menu_settings')); ?>" class="<?php echo e(classActivePath('menu_settings')); ?>"><i class="fa fa-list"></i><span><?php echo e(trans('words.menu')); ?></span></a></li>
                <li class="<?php echo e(classActivePath('recaptcha_settings')); ?>"><a href="<?php echo e(URL::to('admin/recaptcha_settings')); ?>" class="<?php echo e(classActivePath('recaptcha_settings')); ?>"><i class="fa fa-refresh"></i><span> <?php echo e(trans('words.reCAPTCHA')); ?></span></a></li>
                <li class="<?php echo e(classActivePath('web_ads_settings')); ?>"><a href="<?php echo e(URL::to('admin/web_ads_settings')); ?>" class="<?php echo e(classActivePath('web_ads_settings')); ?>"><i class="fa fa-buysellads"></i><span> <?php echo e(trans('words.banner_ads')); ?></span></a></li>

                <li class="<?php echo e(classActivePath('site_maintenance')); ?>"><a href="<?php echo e(URL::to('admin/site_maintenance')); ?>" class="<?php echo e(classActivePath('site_maintenance')); ?>"><i class="fa fa-wrench"></i><span> <?php echo e(trans('words.site_maintenance')); ?></span></a></li>
               </ul>
            </li> 
            ...
            <li class="has_sub"> 
              ...
              <ul class="list-unstyled">                                 
                ...
                <li class="<?php echo e(classActivePath('ad_list')); ?>"><a href="<?php echo e(URL::to('admin/ad_list')); ?>" class="waves-effect <?php echo e(classActivePath('ad_list')); ?>"><i class="fa fa-buysellads"></i><span>Ad Settings</span></a></li>                
    ...
    </div><?php /**PATH C:\xampp\htdocs\getz\resources\views/sidebar.blade.php ENDPATH**/ ?>