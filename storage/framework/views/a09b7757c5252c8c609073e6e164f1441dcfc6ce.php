    ...
    <div class="navbar__left">
        ...
        <button type="button" class="fullscreen-btn">
            ...
            <i class="fullscreen-close las la-compress-arrows-alt" onclick="closeFullscreen();"></i>
              ...
              <a href="<?php echo e(route('home')); ?>" class="btn btn-secondary"><?php echo app('translator')->get('Website'); ?></a>
                 <a href="<?php echo e(route('user.dashboard')); ?>" class="btn btn-primary"><?php echo app('translator')->get('Dashboard'); ?></a>
        </button>
...
<!-- navbar-wrapper end -->
<?php /**PATH C:\xampp\htdocs\getz\resources\views/admin/partialsuser/topnav.blade.php ENDPATH**/ ?>